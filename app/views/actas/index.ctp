<script type="text/javascript">
    $(document).ready(function(){
        $("#list").jqGrid({
            url:'<?php echo $html->url('/actas/indextable?type=1'); ?>',
            datatype:'xml',
            mtype:'GET',
            colNames:['Id', 'Numero', 'Tipo', 'Estado','Asignador','Nombres', 'Apell. paterno', 'Apell. materno', 'Fecha asignación'],
            colModel:[
            ...
            subGridRowExpanded: function(subgrid_id, row_id) {
                ...
                $("#"+subgrid_table_id).jqGrid({
                    url:'<?php echo html_entity_decode($html->url('/inventory_assets/indextable?action=acta_entrega&acta_id=')); ?>' + row_id,
                    datatype: "xml",
...
<div id="dialog-acta" title="Parametrizar Firma">
        <form id="form_acta" method="post" action="<?php echo $html->url('/reports/generate/actas/pdf') ?>" target="_blank">
            ...
            <table>
                ...
                <tr>
                    <td>Entrega: </td>
                    <td><textarea rows="4" cols="30" name="entrega"></textarea></td>
                </tr>
                <tr>
                    <td>Recibe: </td>
                    <td><textarea rows="4" cols="30" name="recibecaja"></textarea></td>
                </tr>
            </table>
        </form>
</div>
