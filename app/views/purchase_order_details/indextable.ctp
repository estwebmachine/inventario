...
//	echo "<cell>" . $result[$i]['PurchaseOrderDetail']['purchase_order_id'] . "</cell>";
	...
	echo "<cell>" . $result[$i]['PurchaseOrderDetail']['currency'] . "</cell>";
	echo "<cell>" . $general->money($result[$i]['PurchaseOrderDetail']['price']) . "</cell>";
        echo "<cell>" . $general->money($result[$i]['PurchaseOrderDetail']['value']) . "</cell>";
	echo "<cell>" . $result[$i]['PurchaseOrderDetail']['created'] . "</cell>";
	echo "<cell>" . $result[$i]['PurchaseOrderDetail']['modified'] . "</cell>";
	echo "</row>";
}
echo "</rows>";
?>