...
//codigo de inventario, largo
$config['lenght_code'] = 7;
...
$config['User']['menu'] = array(
    ...
    __('Control de Bienes', true) => array(//sistema inventario
        ...
        __('Asignación y Desasignación de Bienes', true) => array('controller' => 'inventory_assets', 'action' => 'release'),
	...
	__('Historial de Asignación de Bienes (Bitácora)', true) => array('controller' => 'reports', 'action' => 'bitacora'),
    ...
    __('Parametrización', true) => array(
        ...
        __('Mantenedor Estructura de Inventario (Clases y Genéricos)', true) => array('controller' => 'assets', 'action' => 'structure'),
        __('Mantenedor Direcciones y Oficinas', true) => array('controller' => 'inventory_assets', 'action' => 'locations'),
